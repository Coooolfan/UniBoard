...
1. 下载`.env`文件和`docker-compsoe.yml`文件
    ...
    mkdir uniboard
    cd uniboard
    wget https://github.com/Coooolfan/UniBoard/releases/download/0.2.7/docker-compose.yml    
    wget https://github.com/Coooolfan/UniBoard/releases/download/0.2.7/example.env
    ```
